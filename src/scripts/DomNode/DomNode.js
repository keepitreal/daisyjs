...
var LastCommonParentResult = require('../LastCommonParentResult/LastCommonParentResult');
...
var DomNode = (function () {
    ...
    DomNode.prototype.getParentTree = function () {
    ...
    DomNode.prototype.getLastCommonParent = function (other) {
        ...
        while (isSame && i < nbMyParents && i < nbOtherParents) {
            if (myParents[i].toDiffTag !== otherParents[i].toDiffTag || myParents[i - 1].getIndexOf(myParents[i]) !== otherParents[i - 1].getIndexOf(otherParents[i])) {
                isSame = false;
            }
            else {
    ...
    DomNode.prototype.inPre = function () {
