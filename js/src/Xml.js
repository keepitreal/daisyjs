define(["js/Helpers"], function(Helpers) {
	function Xml() {};
	...
	Xml.elementClean = function(element, attribs, contents) {};
	...
	Xml.openElement = function(element, attribs) {
		attribs = typeof attribs !== "undefined" ? attribs : null;

		return '<' + element + Xml.expandAttributes(attribs) + '>';
	};
     ...
     */
     ...
     Xml.closeElement = function(element){ return "</" + element + ">" };
